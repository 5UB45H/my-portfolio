...
//typing animation script
    ...
    strings: ["Full Stack Web Developer","Web Designer","Blockchain Developer","Security Researcher","Freelancer"],
    typeSpeed: 100,
    backSpeed: 60,
    loop: true
});
  ...
  const secondTyped = new Typed(".typing-2", {
    strings: ["JavaScript Developer","Web Designer","Bug Bounty Hunter","Application Developer","Freelancer"],
    typeSpeed: 100,
    backSpeed: 60,
    loop: true
});  
